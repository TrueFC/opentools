...
_debug=false
_debug_level=1
_debug_commands="merge-aliases"
_debug_functions="merge-aliases"
_dry_run=true
_dry_run=false
...
foo5:	val01'
putdebug 1 merge-aliases.sh file bar
merge-aliases ${file}_1 bar
_debug=false
